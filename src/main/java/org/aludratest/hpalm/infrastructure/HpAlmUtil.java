...
public final class HpAlmUtil {
	 ...
	 * @param path Path to create or to check for existence, e.g. <code>Root/AludraTest/UITest</code>.
	 * 
	 * @return The created or already existing folder at the path. This is an HP ALM "test-set-folder" entity.
	 * 
